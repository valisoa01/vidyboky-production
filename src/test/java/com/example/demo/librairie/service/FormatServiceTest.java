...
class FormatServiceTest {
    ...
    void setUp() {
        ...
        formatRequest = FormatRequest.builder()
                .formatType("Paperback")
                .build();
    }
    ...
    void update_ShouldReturnUpdatedFormat_WhenExists() {
        FormatRequest updateRequest = FormatRequest.builder()
                .formatType("Hardcover")
                .build();

        Format updatedFormat = Format.builder()
                .id(formatId)
                .formatType("Hardcover")
                .build();
    ...
    void update_ShouldThrowException_WhenNotFound() {
        ...
        assertThrows(EntityNotFoundException.class, () -> formatService.update(formatId, formatRequest));
        verify(formatRepository, times(1)).findById(formatId);
        verify(formatRepository, never()).save(any(Format.class));
    }
