...
class BookFormatServiceTest {
    ...
    void setUp() {
        ...
        request = BookFormatRequestDTO.builder()
                .bookId(bookId)
                .formatId(formatId)
                .price((19.99))
                .build();
    ...
    void create_ShouldThrowException_WhenBookNotFound() {
        ...
        RuntimeException exception = assertThrows(RuntimeException.class,
                () -> bookFormatService.create(request));
    ...
    void findById_ShouldThrowException_WhenNotFound() {
        ...
        RuntimeException exception = assertThrows(RuntimeException.class,
                () -> bookFormatService.findById(bookFormatId));
    ...
    void update_ShouldReturnUpdatedBookFormat_WhenExists() {
        BookFormatRequestDTO updateRequest = BookFormatRequestDTO.builder()
                .bookId(bookId)
                .formatId(formatId)
                .price((29.99))
                .build();

        BookFormat updatedBookFormat = BookFormat.builder()
                .id(bookFormatId)
                .book(book)
                .format(format)
                .price((29.99))
    ...
    void update_ShouldThrowException_WhenBookFormatNotFound() {
        ...
        RuntimeException exception = assertThrows(RuntimeException.class,
                () -> bookFormatService.update(bookFormatId, request));
    ...
    void delete_ShouldThrowException_WhenNotFound() {
        ...
        RuntimeException exception = assertThrows(RuntimeException.class,
                () -> bookFormatService.delete(bookFormatId));
