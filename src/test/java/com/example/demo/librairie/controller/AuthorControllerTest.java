...
class AuthorControllerTest {
  ...
  void getById_WithValidId_ShouldReturnAuthor() throws Exception {
    ...
    mockMvc
        .perform(get("/authors/{id}", authorId).contentType(MediaType.APPLICATION_JSON))
        .andExpect(status().isOk())
  ...
  void getById_WithInvalidId_ShouldReturnNotFound() throws Exception {
    ...
    mockMvc
        .perform(get("/authors/{id}", invalidId).contentType(MediaType.APPLICATION_JSON))
  ...
  void delete_WithValidId_ShouldReturnNoContent() throws Exception {
    ...
    mockMvc
        .perform(delete("/authors/{id}", authorId).contentType(MediaType.APPLICATION_JSON))
  ...
  void delete_WithInvalidId_ShouldReturnNotFound() throws Exception {
    ...
    mockMvc
        .perform(delete("/authors/{id}", invalidId).contentType(MediaType.APPLICATION_JSON))
        .andExpect(status().isNotFound());
